...
total_material_price = (nylon_quantity + nylon_extra_quantity) * NYLON_PRICE + (paint_quantity + paint_extra_quantity) * PAINT_PRICE + paint_thinner_quantity * PAINT_THINNER_PRICE + BAG_PRICE
